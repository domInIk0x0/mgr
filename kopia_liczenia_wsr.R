...
mrk <- '6:32095725:T:C'
mrk <- '6:28573714:A:G'  # analogicznie dla wariantu 6:28573714:A:G
...
identity_matrix_r <- calculate_similarity_matrix(hap_matrix_r, reference = 2)
means_r <- calculate_weighted_mean(identity_matrix_r[15: 21,])
View(identity_matrix_r[15: 21,])
...
means_r <- calculate_weighted_mean_fixed(identity_matrix_r)
